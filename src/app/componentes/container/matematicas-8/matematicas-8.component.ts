...
@Component({
  selector: 'app-matematicas-8',
  standalone: false,
  templateUrl: './matematicas-8.component.html',
  styleUrl: './matematicas-8.component.css'
})
export class Matematicas8Component {
  numeros: number[] = [];
  menor: number = 0;
  opciones: number[] = [];
  ...
  verificar(opcionSeleccionada: number): void {
    if (opcionSeleccionada === this.menor) {
